...
exports.up = async function(knex, Promise) {
  await knex.schema.withSchema('public').createTable('hr_att_schedule_breaktime', table => {
    table.uuid('schedule_breaktime_id').primary().defaultTo(knex.raw('public.gen_random_uuid()'))
...
exports.down = async function(knex, Promise) {
  await knex.schema.withSchema('public').dropTable('hr_att_schedule_breaktime')
};
