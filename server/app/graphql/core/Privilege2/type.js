const { GraphQLObjectType, GraphQLList, GraphQLString, GraphQLInt, GraphQLNonNull, GraphQLID } = require('graphql')
...
module.exports = {
  ...
  input: new GraphQLObjectType({
    name: 'CorePrivilegeInput',
