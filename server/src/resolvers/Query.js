...
module.exports = {
  ...
  shiftsConnection: (obj, args, ctx, info) => ctx.db.query.shiftsConnection(args, info),
  ...
  exceptionsConnection: (obj, args, ctx, info) => ctx.db.query.exceptionsConnection(args, info),
